...
## Missing visits and multiple values of change in occupancy psi.yr
...
run_all_simulation_1 <-function(s, all_scenarios){
  ...
  save(sim.data,
       file=paste0(out_dir, "saved_v_psi/", "sim.data/",
                   
"_r_",all_scenarios[s,'r'],"_mu.psi.yr_",all_scenarios[s,'mu.psi.yr'],"_mu.v.yr_",all_scenarios[s,'mu.v.yr'], 
".RData"))
